 ...
 *
 * @property string $name           Optional    The slug used for this block. Defaults to lowercased dirname
 ...
 *
 */
abstract class AbstractACFBlock extends AbstractModule
{
    ...
    public function init(): void
    {
        ...
        View::addNamespace($this->getName(), $this->getBaseDir());
    ...
    {
        return $this->filterProperty('title', ucfirst($this->getName()));
    }
    ...
    {
        echo View::render($this->getName() . "::template", ['block' => $this]);
    }
